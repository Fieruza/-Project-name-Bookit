package com.cybertek.Day10_WebElement;
...
/*
go to amazon
search for lysol disingectin wipes
...
verify the all sports checkbox are checked by default
randomly click any sport
verify that sport is clicked
verify that all other are not clicked
repeat the last step for 5 times

 */

@Test
public void sportCheckBoxTest() throws InterruptedException {
        driver.get("http://practice.cybertekschool.com/radio_buttons");
